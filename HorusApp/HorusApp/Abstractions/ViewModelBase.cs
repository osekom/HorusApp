...
namespace HorusApp.Abstractions
{
    public class ViewModelBase : BindableBase, INavigationAware, IDestructible, IPageLifecycleAware
    {
        ...
        public string EXIT_MESSAGE = "Todo el progreso no guardado se perderá, ¿está seguro de salir?";
        ...
        {
            var response = await UserDialogsService.ActionSheetAsync(EXIT_MESSAGE, "No", "Si");
